            ...
            <div className="flex-1 md:order-1">
              ...
              <div className="prose prose-gray max-w-none">
                ...
                <p className="mb-4">
                  ...
                  meditation and spiritual surrender. His teaching style combines deep wisdom 
                  with practical guidance, helping students navigate both their inner journey 
                ...
                <p className="mb-4">
                  When COVID-19 forced changes to traditional in-person teaching, Stuart 
                  discovered Zoom as a powerful medium to reach his global community of students. 
                  What began as necessity became a blessing—Stuart now teaches classes almost 
                  every day of the week, connecting with students from around the world who 
                  gather to meditate together and receive his guidance.
                </p>
                <p>
                  This website is dedicated to preserving and sharing the deep wisdom that 
                  flows through Stuart during the Q&A sessions that follow each meditation. 
                  These profound exchanges, born from the stillness of deep practice, offer 
                  timeless insights into the nature of consciousness, surrender, and the 
                  spiritual path. Here you can search through years of these precious teachings, 
                  finding guidance and inspiration for your own journey toward inner peace 
